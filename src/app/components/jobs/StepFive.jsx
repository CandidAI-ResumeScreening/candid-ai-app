// src/app/components/jobs/StepFive.jsx
"use client";
...
export default function StepFive() {
  ...
  const generateJobDescription = async () => {
    ...
    try {
      // Create a prompt based on the job details
      const educationInfo = gpa
        ? `GPA: ${gpa}`
        : educationGrade
      ...
      const prompt = `Create a professional job description for a ${title} position at ${companyName}. 
...
Please use bullet points where appropriate. Keep it concise, professional, and engaging.`;

      // Call our Azure OpenAI API route
